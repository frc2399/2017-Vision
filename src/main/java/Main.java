...
public class Main {
	...
	/*
	 * if(!contours1.isEmpty()) { Rect r =
	 * Imgproc.boundingRect(contours1.get(0)); centerX = r.x + (r.width/2);
	 * Imgproc.rectangle(rgb, new Point(r.x, r.y), new Point(r.width, r.height),
	 * new Scalar(225, 0, 0)); smartDash.putNumber("Rectangle Height",
	 * r.height); smartDash.putNumber("Rectangle Width", r.width);
	 *
	 * }
	 *
